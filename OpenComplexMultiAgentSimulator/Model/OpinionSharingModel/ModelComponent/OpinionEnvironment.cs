...
namespace OpenComplexMultiAgentSimulator
{
    class OpinionEnvironment
    {
        ...
        {
            this.EnvironmentAgent = new OsmAgent(-1).SetSubject(this.EnvSubject);
        ...
        public List<Message> SendMessages(List<OsmAgent> sensor_agents, ExtendRandom update_step_rand)
        {
