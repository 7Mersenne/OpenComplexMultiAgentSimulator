...
namespace OpenComplexMultiAgentSimulator
{
    class AgentLink
    {
        ...
        public OsmAgent SourceAgent { get; private set; }
        public OsmAgent TargetAgent { get; private set; }
        ...
        public AgentLink(int link_index, OsmAgent source_agent, OsmAgent target_agent)
        {
            this.AgentLinkID = link_index;
        ...
        public AgentLink SetLink(Link link, List<OsmAgent> agents)
        {
        ...
        public void SetWeight(OsmAgent agent, double weight)
        {
        ...
        public double GetWeight(OsmAgent agent)
        {
            if (this.SourceAgent == agent)
            {
        ...
        public bool IsConnect(OsmAgent agent_a, OsmAgent agent_b)
        {
